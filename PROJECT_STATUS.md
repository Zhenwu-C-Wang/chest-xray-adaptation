...
模块名称                    文件                      行数
─────────────────────────────────────────────────────────────────
NIH ChestX-ray14           data/datasets/nih_chestxray14.py    279
CheXpert                   data/datasets/chexpert.py           220
MIMIC-CXR                  data/datasets/mimic_cxr.py          240
CrossSiteValidator         src/validation/cross_site_validator.py 374
Calibration Methods        src/validation/calibration.py       405
Report Generator           src/validation/report_generator.py   479
示例管道                    scripts/cross_site_validation_example.py 481
─────────────────────────────────────────────────────────────────
核心代码合计                                   ~3,600 行
